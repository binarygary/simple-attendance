<?php
/**
 * Simple_Attendance Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_simple_attendance_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/simple-attendance.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_simple_attendance_plugin' );
